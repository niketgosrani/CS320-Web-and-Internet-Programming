...
<body>
    <div id="header">
        <form action="" method="post">
            <img src="prometric_test_center.png" /><br>
            <br>
            <div class="container">
                ...
                <c:forEach var="quest" items="${questions.rowsByIndex}" varStatus="index">
                    ...
                    <c:choose>
                        ...
                        <div class="QuestionDiv" id="QuestionContainer${index.count}">
                            ...
                            <div id="QuestionDiv${index.count}">
				                ...
				                <br>
				                <div align="center">
				                    <br> <input type="button" class="btn btn-primary submitAnswer" Primary
				                        name="answer" value="TRUE" id="OPT1" data-qid="${quest[0]}" />
				                        <input type="button"
				                        class="btn btn-danger submitAnswer" data-qid="${quest[0]}" Danger name="answer" value="FALSE"
				                        id="OPT2" />
				                </div>
                        ...
                        <c:otherwise>
                            ...
                            <div class="QuestionDiv" id="QuestionContainer${index.count}" style="display:none;">
                            ...
                            <div id="QuestionDiv${index.count}">
                                ...
                                <div align="center">
                                    <br> <input type="button" class="btn btn-primary submitAnswer" Primary
                                        name="answer" value="TRUE" id="OPT1" data-qid="${quest[0]}" />
                                        <input type="button"
                                        class="btn btn-danger submitAnswer" Danger name="answer" value="FALSE"
                                        id="OPT2" data-qid="${quest[0]}" />
                                </div>
